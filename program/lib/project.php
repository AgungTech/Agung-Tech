...
/*
	...
	copyright (c) 2015-2016 Agung Tech Developement

	$Id: project.php,v 0.0.1 26/06/2015 20:38:15 Exp $
	project library

	kontak:
		www.Agung-Tech.blogspot.com
		hudamaruf@gmail.com
*/


/**
* project Shared Memori; format dari variabel ini adalah :
* array (
*	"BLOCK1" => array (
*		"VAR1" => "val1",
*		"VAR2" => "val2"
...
*	)
* )
* Jadi semua yang terkirim ke tsm akan seperti ini $_TSM["BLOCK"]["VAR"] = "value";
