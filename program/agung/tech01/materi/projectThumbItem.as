...
class agung.tech01.materi.projectThumbItem extends MovieClip 
{
	...
	public function projectThumbItem() {
	...
	public function setNode(pNode:XMLNode, pSettingsObj:Object)
	{
		...
		var secondLevel:String = node.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.attributes.browserUrl;
		var thirdLevel:String = node.parentNode.parentNode.parentNode.attributes.browserUrl;
		var fourthLevel:String = node.firstChild.attributes.browserUrl;
		...
		var strArray4:Array = fourthLevel.split("/");
		
		urlAddress = UAddr.contract(firstLevel + "/" + strArray2[1] + "/" + strArray3[1] + "/" + strArray4[1]) + "/";
		
		urlAddressPopupClose = UAddr.contract(firstLevel + "/" + strArray2[1] + "/" + strArray3[1]) + "/";
		
		
		
		var firstLevelTitle:String = _global.parentTitleLevelOne;
		var secondLevelTitle:String = node.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.attributes.browserTitle;
		var thirdLevelTitle:String = node.parentNode.parentNode.parentNode.attributes.browserTitle;
		var fourthLevelTitle:String = node.firstChild.attributes.browserTitle;
		
		urlTitle = firstLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + secondLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + thirdLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + fourthLevelTitle;
		
		urlTitlePopupClose = firstLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + secondLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + thirdLevelTitle;
