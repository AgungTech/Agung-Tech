...
class agung.tech01.materi.scrollerItem extends MovieClip 
{
	...
	public function setNode(pNode:XMLNode, pSettingsObj:Object)
	{
		...
		var secondLevelUrl:String = node.parentNode.parentNode.parentNode.attributes.browserUrl;
		var secondLevelTitle:String = node.parentNode.parentNode.parentNode.attributes.browserTitle;
		
		
		
		var strArray:Array = secondLevelUrl.split("/");
		
		var thirdLevelUrl:String = node.attributes.browserUrl;
		var thirdLevelTitle:String = node.attributes.browserTitle;
		
		var strArray2:Array = thirdLevelUrl.split("/");
		
		urlAddress = UAddr.contract(_global.parentAddressLevelOne + strArray[1] + "/" + strArray2[1]) + "/";
		
		urlTitle = _global.parentTitleLevelOne + " " + _global.globalSettingsObj.urlTitleSeparator + " " + secondLevelTitle + " " + _global.globalSettingsObj.urlTitleSeparator + " " + thirdLevelTitle;
	
		trace(urlAddress + " " + urlTitle);
