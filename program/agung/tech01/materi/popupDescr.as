...
/**
 * this class handles the simple popup description
 * this will take the node, add it's data to the text field and initiate the scroll box
 */
class agung.tech01.materi.popupDescr extends MovieClip
{
	...
	private function updateScrollbar() {
		...
		if (prop >= 1) {
			...
			ScrollButton["over"]._height = ScrollButton["normal"]._height = ScrollArea._height * prop;
			scrollable = true;
