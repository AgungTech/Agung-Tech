...
/**
 * this class handles the materi description
 */
class agung.tech01.materi.description extends MovieClip
{
	...
	/**
	 * here, the node, main settings and the height is being sent and processed
	 * @param	pNode
	 * @param	pMainSettings
	 * @param	pTotalHeight
	 */
	public function setNode(pNode:XMLNode, pMainSettings:Object, pTotalHeight:Number){
		...
		mask._width = mainSettings.moduleWidth - 10;
