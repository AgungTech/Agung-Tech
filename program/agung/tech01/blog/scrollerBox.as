...
class agung.tech01.blog.scrollerBox extends MovieClip 
{
	...
	public function setNode(pNode:XMLNode, pSettingsObj:Object)
	{
		...
		for (; node != null; node = node.nextSibling) {
			var currentItem:MovieClip = lst.attachMovie("IDblogItem", "blogItem" + idx, lst.getNextHighestDepth());
