...
class agung.tech01.blog.scrollerBox2 extends MovieClip
{
	...
	public function setDetails(pNode:XMLNode) {
		...
		if (lastNode != pNode) {
			...
			currentHolder["details" + currentIdx].addEventListener("itemClicked", Proxy.create(this, itemClicked));
			currentHolder["details" + currentIdx].addEventListener("closePopupFull", Proxy.create(this, closePopupFull));
