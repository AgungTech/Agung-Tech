/**
 * This class handles one button for the top right module 
 */
...
class agung.tech01.tentang_orang.topButton extends MovieClip 
{
	...
	/**
	 * this is the constructor where all the variables are being referenced and initialised
	 */
	...
	public function setNode(pNode:XMLNode, pSettingsObj:Object)
	{
		...
		over2["line"]._y = Math.ceil(over2["txt"].textHeight + 2);
