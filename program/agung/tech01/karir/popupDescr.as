...
class agung.tech01.karir.popupDescr extends MovieClip
{
	...
	private function barOnRollOver() {
		Tweener.addTween(bar, { _alpha:100, time:0.15, transition:"linear" } );
	}
	
	private function barOnRollOut() {
		Tweener.addTween(bar, { _alpha:80, time:0.15, transition:"linear" } );
	}
}