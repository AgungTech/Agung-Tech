...
class agung.tech01.karir.popupDetails extends MovieClip
{
	...
	public function setDetails(pType:String) {
		...
		if (pType == "description") {
			...
			currentHolder.attachMovie("IDpopupDescriptionCareers", "descr" + currentIdx, currentHolder.getNextHighestDepth());
	...
	private function show(pMc:MovieClip ) {
		if (init == 1) {
			...
			Tweener.addTween(pMc, { _x:0, _y:0, time:globalSettings.popupDetailsShowAnimationTime, transition:globalSettings.popupDetailsShowAnimationType } );
		}
	}
