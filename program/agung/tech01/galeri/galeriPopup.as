...
class agung.tech01.galeri.galeriPopup extends MovieClip 
{
	...
	/**
	 * fungsi ini mengatur semua data
	 * @param	pNode
	 * @param	pSettingsObj
	 * @param	pPopupMode
	 * @param	pPressedItem
	...
	public function resizaBackFromImage(o:Object) {
		...
		if (!_global.whitePresent) {
			arrowsDefs.nx = Math.ceil(currentPopupDims.w - 12 + 1 );
		}
		else {
