...
class agung.tech01.galeri.popupImage extends MovieClip 
{
	...
	/**
	 * disini, menyeting node dan image
	 * @param	pNode
	...
	// returns: lebar dan tinggi baru dalam pixels
	// type:String - "fit" or "crop"
	// ow:Number, oh:Number - objek original lebar dan tinggi
	// mw:Number, mh:Number - lebar dan tinggi maksimum
	// scaleUp:Boolean - jika true, image akan melebar ke atas dan lebih kecil dari mwxmh
