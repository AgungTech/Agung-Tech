...
class agung.tech01.penjualan.popupHandler extends MovieClip 
{
	...
	public function launchPopup(pPressedItem:MovieClip, pItemsArray:Array, pParentToCancelScroll:MovieClip ) {
	...
	public function setSettings(pSettingsObj:Object)
	{
		...
		trace( settingsObj.popupProtectTransparency + "asdsadasd now")
		loadStageResize();
	}
